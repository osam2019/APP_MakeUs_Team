...
![Imgur](https://imgur.com/a/nKizoRZ)

2. 용사 추가 및 전입병(이병, 일병) 인성평가 및 전입신병 신검 관련 알림 메세지
![Imgur](https://imgur.com/a/m7KwZe8)

3. 로그인시 인성평가 및 전입신병 신검 관련 알림 메세지
![Imgur](https://imgur.com/3MvfMGF)

4. 분대원 전역 처리
![Imgur](https://imgur.com/HHedmgx)


### 체력관리
1. 용사체력정보 관리 및 기록 수정, 확인, 엑셀 파일 출력 관리
![Imgur](https://imgur.com/ee8y8Yt)

2. 용사체력정보 엑셀 출력 파일
![Imgur](https://imgur.com/m5a3juj)
