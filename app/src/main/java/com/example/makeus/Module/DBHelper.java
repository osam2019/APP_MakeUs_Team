...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void updateSoldier(Soldier soldier) {
        updateSoldier(soldier.milliNumber, soldier.name, soldier.rank, soldier.enlistmentDay, soldier.transferDay, soldier.dischargeDay, soldier.birthday, soldier.specialty, soldier.Squad);
    }
